			...
			<body>
				...
				<table>
					...
					<tr class="mdrow">
						...
						<td class="mdvalue">http://creativecommons.org/publicdomain/zero/1.0/</td>
...
De organisatie waar de contactpersoon werkzaam is.
					...
					<tr class="mdrow">
						...
						<td class="mdexplain">Vul hier naar behoefte in, alles wat wel relevant is om te noemen ten aanzien van de dataset maar wat niet past in een van de bovenstaande velden.</td>
					</tr>
				</table>
			</body>
		</html>
