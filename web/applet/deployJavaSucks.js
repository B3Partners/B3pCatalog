...
// modified to not use document.write()
// no, http://java.com/js/dtjava.js is even worse.
...
var deployJava=function(){
    ...
    function getWebStartLaunchIconURL(){
        ...
        try{
            return document.location.protocol.indexOf('http')!=-1?imageUrl:'http:'+imageUrl;
        }catch(err){
...
startApplet+='>';
    if(attributes.placeholder) {
        document.getElementById(attributes.placeholder).innerHTML = startApplet+'\n'+params+'\n'+endApplet;
    } else {
...
versionCheck:function(versionPattern)
{
    ...
    for(var i=0;i<list.length;++i){
        if(this.compareVersionToPattern(list[i],patternArray,familyMatch,minMatch)){
            return true;
        }
    }
return false;
