...
<div id="info" class="tab-definition info-tab">
    ...
    <ol>
        ...
        <li>
            <strong>Publiceer dit bestand op je datapagina of dataportaal</strong>
            Na downloaden van het gemaakte bestand kun je deze zelf publiceren op je eigen datapagina of dataportaal. Als landingspagina van de betreffende dataset.
            <a href="#">lees hoe</a>
        </li>
    </ol>
</div>
